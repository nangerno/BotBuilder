...
const AddVariable = ({ showVariable, setShowVariable, variableData, setVariableData }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div style={{ backgroundColor: '#ddd', padding: '20px', width: '100%', position:'absolute', top:'0', left:'0', borderTopLeftRadius: '10px', borderTopRightRadius: '10px', boxSizing: 'border-box'}}>
                    <h2 style={{ textAlign: 'center', color: '#333', fontSize: '1.4rem', margin: '0'}}>
                        Create entity
                    </h2>
                </div>
